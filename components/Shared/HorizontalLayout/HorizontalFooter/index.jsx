      ...
      <div className="container p-6 mx-auto">
        <div className="lg:flex">
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              <div>
                <a href="/" className="text-2xl font-bold text-white  hover:text-primary ">Wasif Zaman Omee</a>
              </div>

              <p className="max-w-sm mt-2 text-black">Full-Stack Web Developer. 1+ years of experiences</p>
        ...
        <div>
          <p className="text-center">© Developed By Wasif Zaman Omee- All rights reserved</p>
        </div>
      </div>
    </footer>
  )
